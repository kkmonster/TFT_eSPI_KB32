...
#ifndef _TFT_eSPI_KB32H_
#define _TFT_eSPI_KB32H_
...
#define SPI_FREQUENCY  18000000 // Actually sets it to 18 MHz 
#define SPI_READ_FREQUENCY 18000000
...
class TFT_eSPI_KB32 : public Print {
  friend class TFT_eSprite; // Sprite class has access to protected members

//--------------------------------------- public ------------------------------------//
public:

  TFT_eSPI_KB32(int16_t _W = TFT_WIDTH, int16_t _H = TFT_HEIGHT);

  void LED_select(void), LCD_select(void);
...
}; // End of class TFT_eSPI_KB32

#endif // ends #ifndef _TFT_eSPI_KB32H_
